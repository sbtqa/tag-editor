...
import ru.sbtqa.tag.cucumber.inspections.model.CreateStepDefinitionFileModel;
import ru.sbtqa.tag.cucumber.inspections.ui.CreateStepDefinitionFileDialog;
...
public abstract class CucumberCreateStepFixBase implements LocalQuickFix {
  private static final Logger LOG = Logger.getInstance("#ru.sbtqa.tag.cucumber.inspections.CucumberCreateStepFixBase");
  ...
  public static Set<CucumberStepDefinitionCreationContext> getStepDefinitionContainers(@NotNull final GherkinFile featureFile) {
    ...
    result.removeIf(item -> index.getExtensionMap().get(item.getFrameworkType()) == null);
